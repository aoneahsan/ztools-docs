...
<ToolCTA toolId="random-matrix" toolName="random-matrix" />
...
The full random-matrix runs in your browser at **[https://ztools.zaions.com/random-matrix](https://ztools.zaions.com/random-matrix)** — no signup, no upload, no data leaves your device.
