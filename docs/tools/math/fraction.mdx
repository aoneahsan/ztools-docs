...
<ToolCTA toolId="fraction" toolName="fraction" />
...
The full fraction runs in your browser at **[https://ztools.zaions.com/fraction](https://ztools.zaions.com/fraction)** — no signup, no upload, no data leaves your device.
