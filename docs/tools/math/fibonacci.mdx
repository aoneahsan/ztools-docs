...
<ToolCTA toolId="fibonacci" toolName="fibonacci" />
...
The full fibonacci runs in your browser at **[https://ztools.zaions.com/fibonacci](https://ztools.zaions.com/fibonacci)** — no signup, no upload, no data leaves your device.
