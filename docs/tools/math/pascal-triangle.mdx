...
<ToolCTA toolId="pascal-triangle" toolName="Pascal's Triangle" />
...
The full Pascal's Triangle runs in your browser at **[https://ztools.zaions.com/pascal-triangle](https://ztools.zaions.com/pascal-triangle)** — no signup, no upload, no data leaves your device.
