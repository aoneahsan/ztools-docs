...
<ToolCTA toolId="integer-pairs" toolName="integer-pairs" />
...
The full integer-pairs runs in your browser at **[https://ztools.zaions.com/integer-pairs](https://ztools.zaions.com/integer-pairs)** — no signup, no upload, no data leaves your device.
