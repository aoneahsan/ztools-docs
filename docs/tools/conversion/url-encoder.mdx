...
sidebar_label: "URL Encoder/Decoder"
keywords:
  - "url encoder"
  - "url decoder"
  - "percent encoding"
...
<ToolCTA toolId="url-encoder" toolName="URL Encoder/Decoder" />
...
The full URL Encoder/Decoder runs in your browser at **[https://ztools.zaions.com/url-encoder](https://ztools.zaions.com/url-encoder)** — no signup, no upload, no data leaves your device.
