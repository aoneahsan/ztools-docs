...
<ToolCTA toolId="js-to-json" toolName="js-to-json" />
...
The full js-to-json runs in your browser at **[https://ztools.zaions.com/js-to-json](https://ztools.zaions.com/js-to-json)** — no signup, no upload, no data leaves your device.
