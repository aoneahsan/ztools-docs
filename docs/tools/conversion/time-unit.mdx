...
<ToolCTA toolId="time-unit" toolName="time-unit" />
...
The full time-unit runs in your browser at **[https://ztools.zaions.com/time-unit](https://ztools.zaions.com/time-unit)** — no signup, no upload, no data leaves your device.
