...
<ToolCTA toolId="base64" toolName="Base64 Encoder/Decoder" />
...
The full Base64 Encoder/Decoder runs in your browser at **[https://ztools.zaions.com/base64](https://ztools.zaions.com/base64)** — no signup, no upload, no data leaves your device.
