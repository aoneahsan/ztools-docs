...
<ToolCTA toolId="utf8-to-hex" toolName="utf8-to-hex" />
...
The full utf8-to-hex runs in your browser at **[https://ztools.zaions.com/utf8-to-hex](https://ztools.zaions.com/utf8-to-hex)** — no signup, no upload, no data leaves your device.
