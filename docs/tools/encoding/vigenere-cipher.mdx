...
<ToolCTA toolId="vigenere-cipher" toolName="vigenere-cipher" />
...
The full vigenere-cipher runs in your browser at **[https://ztools.zaions.com/vigenere-cipher](https://ztools.zaions.com/vigenere-cipher)** — no signup, no upload, no data leaves your device.
