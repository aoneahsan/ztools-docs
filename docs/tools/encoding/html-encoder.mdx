...
sidebar_label: "HTML Encoder/Decoder"
keywords:
  - "html encoder"
  - "html decoder"
...
<ToolCTA toolId="html-encoder" toolName="HTML Encoder/Decoder" />
...
The full HTML Encoder/Decoder runs in your browser at **[https://ztools.zaions.com/html-encoder](https://ztools.zaions.com/html-encoder)** — no signup, no upload, no data leaves your device.
