...
<ToolCTA toolId="timer" toolName="timer" />
...
The full timer runs in your browser at **[https://ztools.zaions.com/timer](https://ztools.zaions.com/timer)** — no signup, no upload, no data leaves your device.
