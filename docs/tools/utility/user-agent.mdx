...
sidebar_label: "User Agent Parser"
keywords:
  - "user agent"
  - "user agent detector"
  - "browser detector"
...
<ToolCTA toolId="user-agent" toolName="User Agent Parser" />
...
The full User Agent Parser runs in your browser at **[https://ztools.zaions.com/user-agent](https://ztools.zaions.com/user-agent)** — no signup, no upload, no data leaves your device.
