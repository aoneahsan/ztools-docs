...
<ToolCTA toolId="dummy-data" toolName="dummy-data" />
...
The full dummy-data runs in your browser at **[https://ztools.zaions.com/dummy-data](https://ztools.zaions.com/dummy-data)** — no signup, no upload, no data leaves your device.
