...
<ToolCTA toolId="mock-api" toolName="mock-api" />
...
The full mock-api runs in your browser at **[https://ztools.zaions.com/mock-api](https://ztools.zaions.com/mock-api)** — no signup, no upload, no data leaves your device.
