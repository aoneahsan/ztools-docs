...
<ToolCTA toolId="random-string" toolName="random-string" />
...
The full random-string runs in your browser at **[https://ztools.zaions.com/random-string](https://ztools.zaions.com/random-string)** — no signup, no upload, no data leaves your device.
