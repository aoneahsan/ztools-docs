...
<ToolCTA toolId="color-palette" toolName="Color Palette Generator" />
...
The full Color Palette Generator runs in your browser at **[https://ztools.zaions.com/color-palette](https://ztools.zaions.com/color-palette)** — no signup, no upload, no data leaves your device.
